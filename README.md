...
MediaMTX is required for local RTMP streaming. Install it once; the Python service auto-generates MediaMTX config and starts/stops it automatically.
...
```jsonc
{
  ...
  "rtmp_port": 1935,          // optional, default shown
  "cameras": [
    {
      "name": "USB Camera 1",
      "enabled": true,
...
| `streaming` | no | `true` (default) enables local RTMP streaming for this camera |
